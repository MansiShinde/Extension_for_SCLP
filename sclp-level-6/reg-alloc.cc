...
{
	spim_instruction_table[rtl_push] = new RTL_Insn_Descriptor(rtl_push, "push", "",  rtl_op_st, asm_op_st);
	// load 
	...
	spim_instruction_table[rtl_not] = new RTL_Insn_Descriptor(rtl_not, "not", "xori",  rtl_r_op_o1, asm_op_r_o1_o2);
	// move
	...
	spim_instruction_table[rtl_goto] = new RTL_Insn_Descriptor(rtl_goto, "goto", "j",  rtl_op_st, asm_op_st);
	spim_instruction_table[rtl_call] = new RTL_Insn_Descriptor(rtl_call, "call", "jal",  rtl_op_st, asm_op_st);
	spim_instruction_table[rtl_return] = new RTL_Insn_Descriptor(rtl_return, "return",  "", rtl_op_st, asm_op_st);
	spim_instruction_table[rtl_label] = new RTL_Insn_Descriptor(rtl_label, "label", "",  rtl_op_st, asm_op_st);
	// compute
	...
	spim_instruction_table[rtl_seq_d] = new RTL_Insn_Descriptor(rtl_seq_d, "seq.d", "c.eq.d",  rtl_r_o1_op_o2, asm_op_r_o1_o2);
        spim_instruction_table[rtl_slt_d] = new RTL_Insn_Descriptor(rtl_slt_d, "slt.d", "c.lt.d",  rtl_r_o1_op_o2, asm_op_r_o1_o2);
	spim_instruction_table[rtl_sle_d] = new RTL_Insn_Descriptor(rtl_sle_d, "sle.d", "c.le.d",  rtl_r_o1_op_o2, asm_op_r_o1_o2);
	spim_instruction_table[rtl_sgt_d] = new RTL_Insn_Descriptor(rtl_sgt_d, "sgt.d", "c.gt.d",  rtl_r_o1_op_o2, asm_op_r_o1_o2);
	spim_instruction_table[rtl_sge_d] = new RTL_Insn_Descriptor(rtl_sge_d, "sge.d", "c.ge.d",  rtl_r_o1_op_o2, asm_op_r_o1_o2);
	spim_instruction_table[rtl_sne_d] = new RTL_Insn_Descriptor(rtl_sne_d, "sne.d", "c.neq.d",  rtl_r_o1_op_o2, asm_op_r_o1_o2);
	// input output
