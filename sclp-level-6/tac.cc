...
Array_Access_TAC_Opd::Array_Access_TAC_Opd(TAC_Opd * b, TAC_Opd *o)
{
	...
	CHECK_INVARIANT (b->is_variable(), "The base of Access_TAC_Opd must be a variable");
	CHECK_INVARIANT (o->is_variable() ||
		         o->is_temporary() ||
		         o->is_int_const(),
