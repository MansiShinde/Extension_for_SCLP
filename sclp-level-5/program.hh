...
class Program
{
	...
	map<string, Class *> class_map; //added by mansi
...
public:
	...
	Class * get_class_prototype(string class_name); // added by mansi

	void set_proc_to_map(string proc_name, Procedure * proc);


	void set_class_to_map(string class_name, Class * class_nm); //added by mansi
	...
	void set_class_map(map<string, Class *> & class_nm); // added by mansi

	void set_procedure(Procedure * proc, int line);


	void set_class(Class * class_nm, int line); // added by mansi
	...
	bool class_name_exists(string name); // made a change- mansi
	...
	bool class_exists(string class_name); // made a change- mansi
