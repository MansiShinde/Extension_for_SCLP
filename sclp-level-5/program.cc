...
bool Program::class_name_exists(string name)  // added by mansi
{
...
void Program::set_class_map(map<string, Class *> & class_list) // added by mansi
{
...
int Program::count_of_procedures()
{
	...
	for(i = procedure_map.begin(); i != procedure_map.end(); i++)
	{
		//cout<<"Procedure name:"<<i->second->get_proc_name()<<" Return Type:"<<i->second->get_return_type()<<"\n";
		count++;
	}
...
Class * Program::get_class_prototype(string class_name) // added by mansi
{
	// when find functions == end(), means the string has not been found
...
void Program::set_proc_to_map(string proc_name, Procedure * proc)
{
	...
	//cout<<"Procedure name:"<<proc->get_proc_name()<<" Return Type:"<<proc->get_return_type()<<"\n";
}



void Program::set_class_to_map(string class_name, Class * class_nm) // added by mansi
{
	if (class_map.find(class_name) != class_map.end())
	{
		Class * temp = class_map[class_name];
