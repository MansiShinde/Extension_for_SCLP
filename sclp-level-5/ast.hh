...
public:
	...
	virtual Ast * get_opd1();
	virtual Ast * get_opd2();
	virtual bool is_value_zero();
	virtual bool valid_operand();
...
class Addr_Ast:public Ast
{
	Ast * opd;

public:
	Addr_Ast(Ast * opd, int line);
	~Addr_Ast();
...
class Deref_Ast:public Ast
{
	Ast * opd;

public:
	Deref_Ast(Ast * opd, int line);
	~Deref_Ast();
