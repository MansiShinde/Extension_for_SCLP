...
Register_Descriptor * Machine_Description::get_return_register_for_procedure(Data_Type dt)
{
	Register_Descriptor * result_register_id;

	if ((dt == int_data_type) || (dt == string_data_type))
		...
		CHECK_INVARIANT(CONTROL_SHOULD_NOT_REACH, "Wrong return type of function");
