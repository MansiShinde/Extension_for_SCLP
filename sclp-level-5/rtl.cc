...
Data_Type RTL_Opd::get_data_type()
{
	stringstream msg;
...
Data_Type Int_Const_Opd::get_data_type()
{
...
Data_Type Double_Const_Opd::get_data_type()
{
...
void Compute_RTL_Stmt::print_rtl_stmt(ostream & file_buffer)
{
	...
	// In some instruction condition code flag is the result and is implicit.
...
void Control_Flow_RTL_Stmt::print_rtl_stmt(ostream & file_buffer)
{
	...
	case rtl_op_st:
			...
			{
				proc = program_object.get_procedure_prototype(offset);
