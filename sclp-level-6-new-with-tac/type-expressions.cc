...
bool Class_Type_Expr::variable_in_local_class_symbol_list_check(string variable)
{
	return local_class_symbol_table.variable_in_symbol_list_check(variable);
}


bool Class_Type_Expr::variable_in_global_class_symbol_list_check(string variable)
{
...
void Class_Type_Expr::assign_offset_class_var()
{
...
int Class_Type_Expr:: get_global_class_symbol_table_size()
{
	return global_class_symbol_table.get_size_in_bytes();
}

int Class_Type_Expr:: get_local_class_symbol_table_size()
{
	return local_class_symbol_table.get_size_in_bytes();
}

void Class_Type_Expr:: print_sym(ostream & file_buffer)
{
	file_buffer << "\n**CLASS: " << class_name <<"\n" ;
