...
char *yytext;
#line 1 "extend_calc.l"
#line 2 "extend_calc.l"
# include "y.tab.h"
#include <stdio.h>
#include <string.h>
#line 450 "lex.yy.c"
...
case 1:
YY_RULE_SETUP
#line 14 "extend_calc.l"
{yylval.ivalue = atoi(yytext); printf("The digit is :%s\n", yytext); return NUM ;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 17 "extend_calc.l"
{printf("THe operator is: %c\n", yytext[0]); return yytext[0]; }
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 20 "extend_calc.l"
{yylval.str = strdup(yytext); printf("The variable is: %s\n", yytext); return VAR; }
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 24 "extend_calc.l"
ECHO;
	YY_BREAK
#line 747 "lex.yy.c"
