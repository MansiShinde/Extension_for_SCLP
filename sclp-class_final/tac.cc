...
Basic_Data_Type Compute_TAC_Stmt::get_result_data_type()
{
	switch(tac_operator)
	{
		case (add_3a):    return get_basic_data_type(); break;
		case (sub_3a):    return get_basic_data_type(); break;
		case (mult_3a):   return get_basic_data_type(); break;
		case (div_3a):    return get_basic_data_type(); break;
		case (uminus_3a): return get_basic_data_type(); break;
		case (and_3a):    return bool_data_type; break;
		case (or_3a):     return bool_data_type; break;
		case (not_3a):    return bool_data_type; break;
		case (lt_3a):     return bool_data_type; break;
		case (leq_3a):    return bool_data_type; break;
		case (gt_3a):     return bool_data_type; break;
		case (geq_3a):    return bool_data_type; break;
		case (eq_3a):     return bool_data_type; break;
		case (neq_3a ):   return bool_data_type; break;
		case (copy_3a ):  return get_basic_data_type(); break;
		case (deref_3a ): return get_basic_data_type(); break;
		case (addr_3a ):  return get_basic_data_type(); break;
