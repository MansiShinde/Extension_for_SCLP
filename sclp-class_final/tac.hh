...
public:
	...
	RTL_Op get_rtl_operator_for_scalar_tac_operator(); 
	...
	Basic_Data_Type get_result_data_type();
...
private:
	...
	bool handles_aggregate(TAC_Op op);
};
...
public:
	...
	RTL_For_TAC & create_load_rtl_list();
	RTL_For_TAC & create_store_rtl_list(Register_Descriptor * source_register);
	string get_operand_string();
...
class Field_Access_TAC_Opd: public TAC_Opd
{
	TAC_Opd * base;		// Must be a Variable_TAC_Opd
	TAC_Opd * offset;	// Must be a Variable_TAC_Opd

public:
	Field_Access_TAC_Opd(TAC_Opd * b, TAC_Opd *o);
	~Field_Access_TAC_Opd();
