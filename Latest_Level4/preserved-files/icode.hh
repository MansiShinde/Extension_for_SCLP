...
template <class T>
class Const_IC_Opd: public Ics_Opd
{
	T num;
...
public:
	...
	Const_IC_Opd & operator=(const Const_IC_Opd & rhs);
};
...
public:
	...
	virtual void print_icode_comment(ostream & file_buffer);
};
class Write_IC_Stmt: public Icode_Stmt
{
...
class Read_IC_Stmt: public Icode_Stmt
{
 public:
 	Read_IC_Stmt();
 	~Read_IC_Stmt();
