...
RTL_For_TAC & Copy_TAC_Stmt::gen_rtl()
{
	...
	*/
	...
	//cout << "Print load statement " << endl;	// TEST

	//load_stmt.print_rtl_stmt_list(cout);		// TEST
	...
	//store_stmt.print_rtl_stmt_list(cout);		// TEST
	...
	/* After a assignment statement, the local register is freed. 
           So we set no_reg as the result register for RTL_FOR_TAC.
...
RTL_For_TAC & Variable_TAC_Opd::create_load_stmt()
{
	...
	*/
	...
	//cout << "\nRegister is " << dest_register_id->get_name();			//TEST
	//dest_register_opd->print_rtl_opd(cout);		// TEST
...
RTL_For_TAC & Int_Const_TAC_Opd::create_load_stmt()
{
	...
	//load_stmt->print_rtl_stmt(cout); 		// TEST
...
{
	// No need to load a temporary in a new register. It is already in a 
	// register.

	//cout << "Creating load statement for temporary ";		// TEST
	//print_opd(cout);	// TEST
...
{
	//cout << "Creating store statement for temporary ";		// TEST
	//print_opd(cout);	// TEST
	...
	//print_opd_with_register(cout); 			// TEST
...
RTL_For_TAC & Compute_TAC_Stmt::gen_rtl()
{
	...
	//cout << "Generating RTL for TAC ";	// TEST
	...
	//cout << "\nRTL statement created is ";	// TEST
	//compute_stmt->print_rtl_stmt(cout);	// TEST
